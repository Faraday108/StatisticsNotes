...
-   **Area under the curve** evaluates probability as area.
-   Outcomes are measured, not counted
-   Area under curve and above $x$-axis is 1
-   Probability is found for intervals of $x$ values
-   $P(c<x<d)$: Probability that random variable $X$ is in interval and found as area under curve from $x = c$ to $x = d$
